	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		securityanswer=request.getParameter("securityanswer");
			...
			if(password.equals(confirmpassword)){
				UserDao.save(new User(userName, password, confirmpassword,  email, sex, country, securityquestion,securityanswer));
			}
			else {out.println("The password and confirm password does not match!! ");
		}
